<template>
  <div class="role-container p-4">
    <div class="mb-4">
      <el-button type="primary" icon="Plus" @click="handleAdd" v-permission="['system:role:add']">新增角色</el-button>
    </div>
      ...
      <el-table-column label="操作" width="250" fixed="right">
        <template #default="scope">
          <el-button link type="primary" size="small" @click="handleEdit(scope.row)"
            v-permission="['system:role:edit']">编辑</el-button>
          <el-button link type="primary" size="small" @click="handlePermission(scope.row)"
            v-permission="['system:role:edit']">权限配置</el-button>
          <el-button link type="danger" size="small" @click="handleDelete(scope.row)"
            v-permission="['system:role:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="permDialogVisible" title="分配权限" width="600px">
      <el-tree ref="permTreeRef" :data="permissionData" :props="{ label: 'title', children: 'children' }" show-checkbox
