...
// 新增工作台卡片
export const addWorkbenchItem = (data: WorkbenchItem) => {
  return request.post('/api/workbench', data);
};

// 修改工作台卡片
export const updateWorkbenchItem = (id: number, data: WorkbenchItem) => {
  return request.put(`/api/workbench/${id}`, data);
};

// 删除工作台卡片
export const deleteWorkbenchItem = (id: number) => {
